...
class OneFileLoginApplication
{
     ...
     */
    private $db_sqlite_path = "./admin.db";
	private $db_sqlite_path_users = "../users.db";
	...
	private function createDatabaseConnectionUsers()
    {
        try {
            $this->db_connection = new PDO($this->db_type . ':' . $this->db_sqlite_path_users);
            return true;
        } catch (PDOException $e) {
            $this->feedback = "PDO database connection problem: " . $e->getMessage();
        } catch (Exception $e) {
    ...
    private function doRegistration()
    {
        if ($this->checkRegistrationData()) {
            if ($this->createDatabaseConnectionUsers()) {
                $this->createNewUser();
            }
        }
        // default return
